# ════════════════════════════════════════════════════════
#  ALL CONFIGURATION — edit these values before deploying
# ════════════════════════════════════════════════════════

BOT_TOKEN   = "8735896207:AAH8K_frF80e4Woi-PSdzJw76oRICcI3NPE"
ADMIN_ID    = 8502686983
BASE_URL    = "https://your-domain.up.railway.app"  # ← Railway deploy এর পর update করুন
ADMIN_SECRET = "crush_admin_2024"
WEBHOOK_MODE = False     # Local test: False | Railway deploy: True

# Firebase service account — already set
